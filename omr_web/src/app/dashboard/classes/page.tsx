    ...
    <>
      <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            {showArchived ? "Archived sections" : "Active sections this term"}
          </p>
        </div>
        {!showArchived ? (
          <Link
      ...
      {sections.length === 0 ? (
        <EmptyState
          ...
          body={
            showArchived
              ? "When you archive a section on the phone app, it appears here with full history. Restoring brings it back to Active for the phone after Sync Now."
              : "Import a roster in Prepare, or add students in the phone app and Sync Now."
          }
        />
      ) : filtered.length === 0 ? (
