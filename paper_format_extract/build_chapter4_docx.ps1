# Build Chapter 4 DOCX matching THESISREAL / FORMAT_SPEC.md spacing.
# Format source: paper_format_extract/FORMAT_SPEC.md

$ErrorActionPreference = 'Stop'
$outPath = 'd:\omr_app\CHAPTER_4_THESISREAL_FORMAT.docx'
$md = [System.IO.File]::ReadAllText(
  'd:\omr_app\paper_format_extract\chapter4_camera_ready.md',
